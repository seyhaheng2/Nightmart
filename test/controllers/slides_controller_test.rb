...
class SlidesControllerTest < ActionController::TestCase
  ...
  test "should create slide" do
    assert_difference('Slide.count') do
      post :create, slide: { description: @slide.description, image: @slide.image, name: @slide.name, video: @slide.video }
    end
  ...
  test "should update slide" do
    patch :update, id: @slide, slide: { description: @slide.description, image: @slide.image, name: @slide.name, video: @slide.video }
    assert_redirected_to slide_path(assigns(:slide))
  end
